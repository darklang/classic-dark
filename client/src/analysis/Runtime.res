...
let toRepr = (dval: RT.Dval.t, secrets: list<string>): Tea.Html.html<AppTypes.msg> => {
  Tea.Html.text(Util.hideSecrets(toStringRepr(dval), secrets))
}
